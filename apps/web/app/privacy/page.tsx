      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <GlassCard hover={false} className="mb-8">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-white mb-4">מחויבות לפרטיותכם</h2>
        ...
        {/* Cookies */}
        <GlassCard hover={false} className="mb-8">
          <h2 className="text-xl font-semibold text-white mb-4">שימוש בעוגיות (Cookies)</h2>
        ...
        {/* User Rights */}
        <GlassCard hover={false} className="mb-8">
          <h2 className="text-xl font-semibold text-white mb-4">הזכויות שלכם</h2>
          <div className="space-y-4 text-white/70">
        ...
        <GlassCard hover={false} gold>
          ...
          <div className="space-y-2 text-white/70">
            ...
            <p>
              ...
              <a href="mailto:privacy@stannel.co.il" className="text-gold-400 hover:underline">
